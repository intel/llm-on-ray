...
https://github.com/bigcode-project/bigcode-dataset/blob/main/pii/pii_redaction.py
"""
import json
import random
import secrets
...
def redact_pii_batch(examples, replacements, add_references=True):
    ...
    result = {"secrets":examples["secrets"],"new_content": new_contents, "modified": modified}
    if add_references:
