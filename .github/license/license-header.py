...
def parse_args():
    ...
    parser.add_argument("--header", default=".github/license/license.header", help="header file")
    parser.add_argument(
        "--extra",
        default=80,
    ...
    parser.add_argument("--remove", default=False, action="store_true", help="remove the header")
    parser.add_argument(
        "-v", default=False, action="store_true", dest="verbose", help="verbose output"
    )
    group = parser.add_mutually_exclusive_group()
    group.add_argument("-k", default=False, action="store_true", dest="check", help="check headers")
    group.add_argument(
        "-i",
        default=False,
        action="store_true",
