...
def test_models(openai_testing_model):  # noqa: F811
...
def test_completions(openai_testing_model):  # noqa: F811
...
def test_chat(openai_testing_model):  # noqa: F811
...
def test_completions_bad_request(openai_testing_model):  # noqa: F811
...
def test_chat_bad_request(openai_testing_model):  # noqa: F811
    with pytest.raises(openai.BadRequestError) as exc_info:
...
def test_completions_stream(openai_testing_model):  # noqa: F811
    i = 0
...
def test_chat_stream(openai_testing_model):  # noqa: F811
    i = 0
...
def test_completions_stream_bad_request(openai_testing_model):  # noqa: F811
